...
public class Psychology implements Serializable {
    ...
    public Psychology(Integer id, String number, String name, String chooseone, String choosetwo, String choosethree, String choosefour, String choosefive, String choosesix, String chooseseven, String chooseeight, String date) throws Exception {
        this.id = id;
        this.number = number;
        this.name = name;
        this.chooseone = chooseone;
